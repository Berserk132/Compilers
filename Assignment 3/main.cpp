...
enum TokenType{
    IF, THEN, ELSE, END, REPEAT, UNTIL, READ, WRITE, FOR, FROM, TO, STARTFOR, ENDFOR, INC,BREAK,
...
const char* TokenTypeStr[]=
        {
                "If", "Then", "Else", "End", "Repeat", "Until", "Read", "Write", "For", "Break",
                "From", "To", "StartFor", "EndFor", "Inc",
...
TreeNode* IfStmt(CompilerInfo* pci, ParseInfo* ppi)
{
    ...
    else
    {
        ...
        if(ppi->next_token.type==BREAK) Match(pci, ppi, BREAK);tree->b= true;
    }
